...
class DABot:
    def __init__(self):
        ...
        self.thread_sock = threading.Thread(target=self.start)
        self.thread_disp = threading.Thread(target=self.display)
    ...
    def setPram(self):
        ...
        self.exchange = eval(input("Exchange: "))
