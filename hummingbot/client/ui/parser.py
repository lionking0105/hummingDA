...
from hummingbot.client.command.startDA_command import StartDACommand
...
def load_parser(hummingbot: "HummingbotApplication", command_tabs) -> [ThrowingArgumentParser, Any]:
    ...
    def startDA():
        ...
        hummingbot.exit(True)
           
    startDA_parser = subparsers.add_parser("startDA", help = "Start the DA trading bot")
    startDA_parser.set_defaults(func=startDA)
